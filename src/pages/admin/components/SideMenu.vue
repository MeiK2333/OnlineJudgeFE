<template>
  <el-menu class="vertical_menu"
    ...
    <el-submenu v-if="isSuperAdmin || isSecondary" index="general">
      ...
      <el-menu-item v-if="isSuperAdmin" index="/friendship_links">友情链接管理</el-menu-item>
    ...
    <el-submenu index="problem" v-if="hasProblemPermission">
      ...
      <el-menu-item v-if="canExportProblem" index="/problem/batch_ops">{{$t('m.Export_Import_Problem')}}</el-menu-item>
      <el-menu-item v-if="isSuperAdmin" index="/problem/tags">题目标签管理</el-menu-item>
    </el-submenu>
